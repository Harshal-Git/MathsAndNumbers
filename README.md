...
9. Prime factors of given number. Divisors of a number which are prime. (com.primeFactorsOrDivisors)
...
10. Print all divisors of a number. (com.factorsOrDivisorsOfANumber)
